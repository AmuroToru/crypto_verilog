module padding_sha3_224(
    ...
    output reg [1151:0] out,      // 1152/8 = 144字节
    output              msg_done
);

    // SHA3-224参数: rate = 1152 bits = 144 bytes
    localparam RATE_BYTES  = 8'd144;   // 1152/8
    localparam RATE_LAST   = 8'd143;
    localparam RATE_BITS   = 1152;
