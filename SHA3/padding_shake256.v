module padding_shake256(
    ...
    output reg [1087:0] out,      // 1088/8 = 136字节
    output              msg_done
);

    // SHAKE256参数: rate = 1088 bits = 136 bytes
    localparam RATE_BYTES  = 8'd136;   // 1088/8
    localparam RATE_LAST   = 8'd135;
