module padding_sha3_512(
    ...
    output reg  [575:0] out,      // 576/8 = 72字节
    output              msg_done
);

    // SHA3-512参数: rate = 576 bits = 72 bytes
    localparam RATE_BYTES  = 8'd72;
    localparam RATE_LAST   = 8'd71;
    localparam RATE_BITS   = 576;
