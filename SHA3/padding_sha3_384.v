module padding_sha3_384(
    ...
    output reg [1023:0] out,      // 1024/8 = 128字节
    output              msg_done
);

    // SHA3-384参数: rate = 1024 bits = 128 bytes
    localparam RATE_BYTES  = 8'd128;
    localparam RATE_LAST   = 8'd127;
    localparam RATE_BITS   = 1024;
